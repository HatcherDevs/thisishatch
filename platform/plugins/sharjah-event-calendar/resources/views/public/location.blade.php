...
@section('title', __('Events at: :location', ['location' => $location->name]))

@section('content')
    <div class="container py-5">
        <div class="row">
            <div class="col-12">
                <h1 class="mb-4">{{ __('Events at: :location', ['location' => $location->name]) }}</h1>

                @if($location->address)
                    <p class="text-muted mb-4">{{ $location->address }}</p>
                @endif
                ...
                <div class="row">
                    ...
                    @empty
                        <div class="col-12">
                            <p>No events found at this location.</p>
                        </div>
                    @endforelse
                </div>
