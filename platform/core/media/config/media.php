...
return [
    ...
    // 🔒 Security: محدود بأنواع آمنة فقط - ممنوع php, phtml, exe, sh, bat
    'allowed_mime_types' => env(
        'RV_MEDIA_ALLOWED_MIME_TYPES',
        'jpg,jpeg,png,gif,svg,txt,docx,ico,icon,zip,mp3,bmp,csv,xls,xlsx,ppt,pptx,pdf,mp4,m4v,doc,mpga,wav,webp,webm,mov,jfif,avif'
    ),

    // 🔒 Security: ممنوع رفع أي نوع ملفات للأدمن (حماية من backdoors)
    'allowed_admin_to_upload_any_file_types' => false,

    // 🔒 Security: الامتدادات المحظورة (ملفات تنفيذية خطيرة)
    ...
    // 🔒 Security: MIME types مسموحة فقط (تحقق صارم)
    'mime_types' => [
        'image' => [
            'image/png',
            'image/jpeg',
        ...
        'zip' => [
            ...
            // تحذير: rar محذوف لأنه قد يحتوي على ملفات خطيرة
        ],
        'audio' => [
            'audio/mpeg',
            'audio/mp3',
    ...
    // 🔒 Security: حد أقصى لحجم الملف (10MB للصور، 50MB للفيديو)
    'max_file_size' => [
