# HatchConceptStudio Theme for Botble CMS
...
@extends('theme.hatch-concept-studio::layouts.full-width')
...
Use in templates:
```blade
<h1>{{ __('theme.hatch-concept-studio::theme.welcome') }}</h1>
```
