...
<ul class="nav nav-pills mb-3" id="projects-tab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button
            class="nav-link p-0"
            id="Creative-Campaigns-tab"
            data-bs-toggle="pill"
            data-bs-target="#Creative-Campaigns"
            type="button"
            role="tab"
            aria-controls="Creative-Campaigns"
            aria-selected="false"
        >
            <img id="arrow" width="15px" src="{{ Theme::asset()->url('imgs/projects/Arrow.png') }}" alt="" />
            Creative Campaigns
    ...
    <div class="container w-md-75">
        ...
        <div class="tab-content pb-5 mb-5" id="pills-tabContent">
            <div class="tab-pane fade show active" id="Branding" role="tabpanel" aria-labelledby="Branding-tab">
                <div class="row">
                    <div class="col-md-6">
                        <a href="{{ route('public.single', 'project-details') }}" class="text-decoration-none project_item">
                            <img
                                src="{{ Theme::asset()->url('imgs/projects/project-details/Guided-By-The-Stars.jpg') }}"
                                class="card-img-top"
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('public.single', 'project-details') }}" class="text-decoration-none project_item">
                            <img src="{{ Theme::asset()->url('imgs/projects/Project Image 1.png') }}" class="card-img-top" alt="Watson's Regional Campaign" loading="lazy" />
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('public.single', 'project-details') }}" class="text-decoration-none project_item">
                            <img src="{{ Theme::asset()->url('imgs/projects/Project Image 1.png') }}" class="card-img-top" alt="Project" loading="lazy" />
                            <h5 class="card-title pt-2">Guided by the Stars</h5>
                            <p>Illustration | Storytelling</p>
                        </a>
                    </div>
            ...
            <div class="tab-pane fade" id="Creative-Campaigns" role="tabpanel" aria-labelledby="Creative-Campaigns-tab">
                <div class="row">
                    <div class="col-md-6">
                        <a href="{{ route('public.single', 'project-details') }}" class="text-decoration-none project_item">
                            <img src="{{ Theme::asset()->url('imgs/projects/Project Image 1.png') }}" class="card-img-top" alt="Project" loading="lazy" />
